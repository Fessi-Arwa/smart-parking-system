...
// Fix pour les icônes Leaflet (utilisation de CDN si les assets locaux n'existent pas)
      ...
      const marker = L.marker([parking.latitude, parking.longitude], { icon: parkingIcon })
        ...
        .bindPopup(`
          <div class="parking-popup">
            ...
            ${parking.adresse}<br>
            <span class="popup-price">${parking.price}€/heure</span><br>
            <span class="popup-spaces">${parking.availableSpaces} places disponibles</span><br>
            <button class="popup-btn" data-id="${parking.id}">Réserver</button>
          </div>
        `);
